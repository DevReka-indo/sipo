...
@section('title', 'Cetak Laporan Memo')
    ...
    <div class="container-fluid px-4 py-0 mt-0">
        <div class="card shadow-sm border-0">
            <div class="card-body py-3">
                ...
                <h3 class="fw-bold mb-3">Cetak Laporan Memo</h3>
                ...
                <div class="row mb-3">
                    <div class="col-12">
                        <div class="bg-white border rounded-2 px-3 py-2 w-100 d-flex align-items-center">
                            ...
                            <a href="{{ route('laporan-memo.superadmin') }}" class="text-decoration-none text-primary">
                                Laporan
                            </a>
                            <span class="mx-2 text-muted">/</span>
                            <span class="text-muted">Cetak Laporan Memo</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col d-flex justify-content-between align-items-center mb-2">
                    <form method="POST" action="{{ route('cetak-laporan-memo.filter') }}"
                    ...
                    `;
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                const url = new URL("{{ route('format-cetakLaporan-memo') }}", window.location.origin);
