    ...
    <div class="container-fluid px-4 py-0 mt-0">
        <div class="card shadow-sm border-0">
            <div class="card-body py-3">
                ...
                <h3 class="fw-bold mb-3">Laporan Undangan Rapat</h3>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="card border-0 shadow-sm rounded-3">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <small class="text-danger">* Masukkan tanggal awal filter data undangan
                                                rapat!</small>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="card border-0 shadow-sm rounded-3">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <small class="text-danger">* Masukkan tanggal akhir filter data undangan
                                                rapat!</small>
                                        </div>
                                    </div>
                                </div>
