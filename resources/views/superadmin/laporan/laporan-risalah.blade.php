    ...
    <div class="container-fluid px-4 py-0 mt-0">
        <div class="card shadow-sm border-0">
            <div class="card-body py-3">
                ...
                <h3 class="fw-bold mb-3">Laporan Risalah Rapat</h3>
                ...
                <div class="row mb-3">
                    <div class="col-12">
                        <div class="bg-white border rounded-2 px-3 py-2 w-100 d-flex align-items-center">
                            ...
                            <span class="text-muted ms-1">/ Laporan </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-sm rounded-3">
                    <div class="card-body">
                        <form action="{{ route('cetak-laporan-risalah.filter') }}" method="POST" id="filter-form">
                            <div class="row">
                                @csrf
                                {{-- Tanggal Awal --}}
                                    ...
                                    <div class="card border-0 shadow-sm rounded-3">
                                        ...
                                        <div class="card-body">
                                            <input type="date" name="tgl_awal" id="tgl_awal" class="form-control"
                                                required>
                                            <small class="text-danger">* Masukkan tanggal awal filter data risalah
                                                rapat!</small>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card border-0 shadow-sm rounded-3">
                                        ...
                                        <div class="card-body">
                                            <input type="date" name="tgl_akhir" id="tgl_akhir" class="form-control"
                                                required>
                                            <small class="text-danger">* Masukkan tanggal akhir filter data risalah
                                                rapat!</small>
                                        </div>
                                    </div>
                                </div>
