...
<body class="{{ isset($isPdf) && $isPdf ? 'pdf-mode' : 'view-mode' }}">
    <header>
        @if (isset($headerImage))
            <img src="{{ $headerImage }}" width="100%" alt="Header">
        @endif
    </header>
                    ...
                    <div class="col-md-12">
                        <div class="fill">
                            <h3 style="text-align: left;">
                                Laporan Tgl. {{ \Carbon\Carbon::parse($tgl_awal)->format('d-m-Y') }} /
                ...
                <div>
                    ...
                    <div style="width: 40%; margin-left: auto; text-align: left; line-height: 1.3; margin-top: 20px;">
                        ...
                        <p style="margin: 0; text-align: center;">
                            <strong>
                                <u>{{ $manager->firstname }}{{ $manager->lastname ? ' ' . $manager->lastname : '' }}</u></strong>
                        </p>
                    </div>
